    ...
    return (
      <div className="min-h-screen bg-paybancx-bg pb-16 md:pb-6">
        ...
        <header className="bg-white border-b border-paybancx-border">
          <div className="max-w-7xl mx-0 px-3 xs:px-4 sm:px-5 md:px-6 py-2.5 sm:py-3 md:py-3 flex items-center gap-3">
            <button
              onClick={() => router.back()}
              title="Go back"
        ...
        <main className="max-w-7xl mx-0 px-3 xs:px-4 sm:px-5 md:px-6 py-4 w-full">
