  ...
  return (
    <div className="min-h-screen bg-[#F5F6F8] pb-12 md:pb-6">
      ...
      <div className="bg-white border-b border-[#2D5D59]/10 sticky top-0 z-10">
        <div className="max-w-7xl mx-0 px-3 xs:px-4 sm:px-5 md:px-6 lg:px-8 py-3 sm:py-4 md:py-4">
      ...
      {/* Main Content */}
      <main className="max-w-7xl mx-0 px-3 xs:px-4 sm:px-5 md:px-6 lg:px-8 py-4 md:py-5">
