  ...
  return (
    <div className="min-h-screen bg-[#F5F6F8] text-[#122927]">
      <div className="border-b border-[#1C3F3B]/10 bg-white">
        <div className="mx-auto flex max-w-6xl items-center gap-3 px-3 py-3 xs:px-4 sm:px-5 sm:py-4 md:px-6">
          <button
            onClick={() => router.back()}
            title="Go back"
            aria-label="Go back"
      ...
      <main className="mx-auto flex max-w-6xl flex-col gap-4 px-3 py-4 xs:px-4 sm:px-5 sm:py-5 md:px-6 lg:py-6">
